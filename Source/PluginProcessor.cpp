...
parameters(*this, nullptr, juce::Identifier("FMSynth"), {
    ...
    std::make_unique<juce::AudioParameterChoice>(pid("osc1Waveform", 1), "Osc 1 Waveform", juce::StringArray { "Sine", "Saw" }, 0),
    ...
    std::make_unique<juce::AudioParameterChoice>(pid("osc2Waveform", 1), "Osc 2 Waveform", juce::StringArray { "Sine", "Saw" }, 0),
    ...
    std::make_unique<juce::AudioParameterChoice>(pid("osc3Waveform", 1), "Osc 3 Waveform", juce::StringArray { "Sine", "Saw" }, 0),
    ...
    std::make_unique<juce::AudioParameterChoice>(pid("osc4Waveform", 1), "Osc 4 Waveform", juce::StringArray { "Sine", "Saw" }, 0),
