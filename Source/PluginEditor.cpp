...
: AudioProcessorEditor (&p), audioProcessor (p), oscs(vts), modTab1(vts), modTab2(vts), parameters(vts)
{
    ...
    tabs.addTab("Modulators", backgroundColour, &modTab1, false);
    tabs.addTab("Modulators 2", backgroundColour, &modTab2, false);
