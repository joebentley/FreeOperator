...
parameters(*this, nullptr, juce::Identifier("FMSynth"), {
    ...
    std::make_unique<juce::AudioParameterFloat>(pid("osc1LevelRandom", 1), "Osc 1 Level Random", 0.0, 1.0, 0.0),
    ...
    std::make_unique<juce::AudioParameterFloat>(pid("osc2LevelRandom", 1), "Osc 2 Level Random", 0.0, 1.0, 0.0),
    ...
    std::make_unique<juce::AudioParameterFloat>(pid("osc3LevelRandom", 1), "Osc 3 Level Random", 0.0, 1.0, 0.0),
    ...
    std::make_unique<juce::AudioParameterFloat>(pid("osc4LevelRandom", 1), "Osc 4 Level Random", 0.0, 1.0, 0.0),
